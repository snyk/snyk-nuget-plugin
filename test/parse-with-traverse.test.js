...
var targetPackagesConfigFile = stubProjectLocation + 'dummy_project_1/packages.config';
var alternatePackagesFolder = stubProjectLocation + 'alternate_packages';
var targetCSProjFile = stubProjectLocation + 'dummy_project_1/WebApplication1.csproj';


test('parse .csproj and traverse packages', function (t) {
  var expectedTreeFile =
    fs.readFileSync(stubProjectLocation + 'dummy_project_1/expected_csproj.json');
...
test('parse packages.config and traverse packages', function (t) {
  var expectedTreeFile =
    fs.readFileSync(stubProjectLocation + 'dummy_project_1/expected_pkgcfg.json');
  var expectedTree = JSON.parse(expectedTreeFile.toString());
...
test('parse packages.config and traverse alternate packages folder', function (t) {
  var expectedTreeFile =
    fs.readFileSync(stubProjectLocation + 'dummy_project_1/expected_pkgcfg.json');
  var expectedTree = JSON.parse(expectedTreeFile.toString());
