...
const packageReferenceParser = require('./package-reference-parser');

const PARSERS = {
  'dotnet-core': {
    depParser: dotnetCoreParser,
    fileContentParser: packageReferenceParser,
  },
  'project.json': {
...
module.exports = {
  buildDepTreeFromFiles: function (root, targetFile, packagesFolderPath, manifestType, useProjectNameFromAssetsFile) {
    ...
    return parser.depParser.parse(
      tree,
      parser.fileContentParser.parse(fileContent, tree, useProjectNameFromAssetsFile),
      targetFramework,
      packagesFolder);
  },
};
